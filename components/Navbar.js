...
const Navbar = () => {
  return (
    <div className='w-full relative z-40'>
        <nav className='absolute flex justify-between items-center bg-white text-black w-full h-12 md:h-16 p-4 border-b border-gray-200'>
            <Link href="/" className='flex justify-center items-center w-12 md:w-16 h-auto'>
                <Image src="/vercel.svg" width={400} height={360} className="w-full h-auto"/>
            </Link>
